...
function Button({ text, href = "#", style = 1 }: ButtonProps) {
  ...
  const style1 = "block w-full rounded bg-secundary-200 px-12 py-3 text-sm font-medium text-white shadow hover:bg-blue-600 focus:outline-none focus:ring active:bg-blue-700 sm:w-auto";
